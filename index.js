...
findFourth([3, 6, 9, 12, 16, 18])
// prints 12 in this case
//still O(1) so not better time complexity anyway
...
// ANSWER: there are no nested loops, however the size of the argument could vary
